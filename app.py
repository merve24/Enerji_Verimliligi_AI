...
st.title("💡 Enerji Verimliliği RAG Uzmanı") # Başlık güncellendi
st.markdown("Bu chatbot, 1000 sayfalık 'Enerji Verimliliği Eğitim Kitabı' veritabanına bağlanır ve Gemini 2.5 Flash ile akıl yürüterek sorularınızı yanıtlar.") # Yeni açıklama
