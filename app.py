...
def rag_query_streamlit(query, k=8): 
    ...
    # KRİTİK DÜZELTME: response_embedding nesne olduğu için sözlük erişimi ['embedding'] yerine
    # nokta notasyonu .embedding[0] kullanılıyor. Bu, önceki TypeError'ı çözer.
