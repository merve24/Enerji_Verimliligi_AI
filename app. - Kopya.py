import os
# Protobuf sürüm çakışmasını engellemek için en üstte olmalıdır
...
if collection is None:
    st.error(f"'{CORRECT_FILE_NAME}' dosyası bulunamadı.")
    st.stop()
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [{'role': 'assistant', 'content': 'Merhaba! Enerji verimliliği hakkında sorularınızı yanıtlamaya hazırım.⚡'}]
