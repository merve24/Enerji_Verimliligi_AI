...
# Eski SDK'lardan kalan ve çakışmaya neden olan importlar kaldırıldı.
    ...
    try:
        with st.status("Metin parçaları vektörleştiriliyor...", expanded=True) as status:
            for i, chunk in enumerate(text_chunks):
                ...
                # DÜZELTME: API yanıtına nokta notasyonu ile erişildi.
        ...
        # Genel hata yakalama, eski SDK hataları yerine
