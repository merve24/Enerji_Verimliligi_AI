    ...
    try:
        ...
        for i, chunk in enumerate(text_chunks):
            response = client.models.embed_content(
                model='text-embedding-001',  # Daha güncel embedding modeli
                contents=[chunk]
            )
...
def simple_query_streamlit(prompt, text_chunks, embeddings, api_key):
    ...
    try:
        ...
        rag_prompt = (
            ...
            f"Kullanıcı sana enerji yönetimi, sürdürülebilirlik ve verimlilik konularında soru soracak.\n\n"
            f"TALİMATLAR:\n"
            f"- Cevaplarını **yalnızca aşağıdaki KAYNAK METİN** içeriğine dayanarak oluştur.\n"
            f"- Eğer bilgi kaynakta yoksa, şu şekilde cevap ver: "
            f"'Üzgünüm, bu sorunun cevabını elimdeki Enerji Verimliliği Eğitim Kitabında bulamıyorum.'\n"
            f"- Gerektiğinde kaynak metinlerdeki bilgileri birleştirip mantıklı açıklamalar yapabilirsin.\n\n"
            f"KAYNAK METİN:\n---\n{retrieved_text}\n---\n\n"
