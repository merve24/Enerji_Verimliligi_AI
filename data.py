...
def simple_query_streamlit(prompt, collection, api_key):
    ...
    # --- MODEL CEVAP ÜRETİMİ (Retry Logic, Hız Optimizasyonu ve Temperature Ayarı) ---
    try:
        rag_prompt = (
        ...
        # HIZ OPTİMİZASYONU 2: Yanıt uzunluğunu ve determinizmi sınırlandıran config oluşturuldu
        config = genai.types.GenerateContentConfig(
            max_output_tokens=MAX_RESPONSE_TOKENS, 
            temperature=0.0 # Kesinliği artırır ve potansiyel olarak hızı artırır
        )
