...
import time # Hata durumunda beklemek ve bekleme süresi eklemek için eklendi
...
def simple_query_streamlit(prompt, collection, api_key):
    # Bu fonksiyon generator (yield) kullanarak akışı döndürür.
            ...
            for chunk in response_stream:
                if chunk.text:
                    ...
                    for char in chunk.text:
                        yield char
                        time.sleep(0.015) # 15 milisaniye bekleme
